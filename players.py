...
#import random
#        first_index = random.randint(1,100)
#        last_index = random.randint(1,100)
#        self.bankroll = random.randint(100,500)
#        self.first_name = POSSIBLE_FIRST_NAMES[first_index]
#        self.last_name = POSSIBLE_FIRST_NAMES[first_index]
